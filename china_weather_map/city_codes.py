...
# 省份名 -> 行政区划代码(adcode)，用于从阿里云 DataV 获取省级地图 GeoJSON
# adcode 即省级6位码，来源与 static/china.json 中各省份的 adcode 字段一致
PROVINCE_ADCODE_MAP = {
    ...
    "甘肃": "620000", "青海": "630000", "台湾": "710000",
    "内蒙古": "150000", "广西": "450000", "西藏": "540000",
    "宁夏": "640000", "新疆": "650000",
    "香港": "810000", "澳门": "820000",
}

# 省份 -> 该省下辖城市名列表（与 CITY_CODE_MAP 中的 key 对应）
PROVINCE_CITIES_MAP = {
    "北京": ["北京"],
    "天津": ["天津"],
    "上海": ["上海"],
...
def get_province_adcode(province_name: str) -> str | None:
    """根据省份简称获取行政区划代码"""
    return PROVINCE_ADCODE_MAP.get(province_name)


def get_province_cities(province_name: str) -> list:
    """根据省份简称获取下辖城市列表"""
    return PROVINCE_CITIES_MAP.get(province_name, [])
